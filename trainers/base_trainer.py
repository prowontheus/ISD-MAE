...
class BaseTrainer(ABC):
    ...
    def _load_pretrained(self, checkpoint_file, device):
        ...
        self.model.load_state_dict(torch.load(checkpoint_file, map_location=device), strict=False)
    ...
    def _delete_old_weights(self, nun_max_keep):
        ...
        for weight_file in weights_files:
            if 'aux' in weight_file: continue
